        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandardCategoryId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Domains_Standards_StandardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplianceLevel = table.Column<int>(nullable: false),
                    CalculatedCompliance = table.Column<double>(nullable: false),
                    Description = table.Column<string>(maxLength: 4000, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questionaries_Standards_StandardId",
                        column: x => x.StandardId,
                        principalTable: "Standards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Text = table.Column<string>(maxLength: 1000, nullable: false),
                    AnswersList = table.Column<string>(maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Controls_ControlId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnswerValue = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Controls_DomainId",
                table: "Controls",
                column: "DomainId");

            migrationBuilder.CreateIndex(
                name: "IX_Domains_StandardId",
                table: "Domains",
                column: "StandardId");

            migrationBuilder.CreateIndex(
                name: "IX_Questionaries_StandardId",
                table: "Questionaries",
                column: "StandardId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_ControlId",
                table: "Questions",
                column: "ControlId");
